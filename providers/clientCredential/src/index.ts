 ...
 *
 * ------------------------------------------------
 * Change "CustomDriver" to something more relevant
 * ------------------------------------------------
 */
export type CustomDriverAccessToken = {
  token: string
  type: 'bearer'
}
 ...
 * ------------------------------------------------
 */
export type CustomDriverScopes = string
 ...
 * ------------------------------------------------
 */
export class CustomDriver extends Oauth2Driver<CustomDriverAccessToken, CustomDriverScopes> {
  /**
   ...
   */
  protected stateCookieName = 'CustomDriver_oauth_state'
  ...
  constructor(ctx: HttpContextContract, public config: CustomDriverConfig) {
    super(ctx, config)
   ...
   */
  // protected configureRedirectRequest(request: RedirectRequest<CustomDriverScopes>) {}
  ...
  ): Promise<AllyUserContract<CustomDriverAccessToken>> {
